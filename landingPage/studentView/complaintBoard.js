 ...
 const inputs = Array.from(document.getElementsByTagName('input')); // Convert HTMLCollection to an array
 const textareas = Array.from(document.getElementsByTagName('textarea')); // Convert HTMLCollection to an array
...
function applyTheme(theme) {
    if (theme === 'dark') {
        ...
        textareas.forEach(textarea => textarea.classList.remove('dark'));
