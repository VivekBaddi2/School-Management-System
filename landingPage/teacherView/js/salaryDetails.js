...
const salaryDetailsContainer = document.getElementById('salaryDetailsContainer');
...
function applyTheme(theme) {
    if (theme === 'dark') {
        ...
        salaryDetailsContainer.classList.add('dark');
        ...
        salaryDetailsContainer.classList.remove('dark');
    }
